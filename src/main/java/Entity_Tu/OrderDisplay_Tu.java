...
public class OrderDisplay_Tu {
    ...
    public OrderDisplay_Tu() {
    }

    public OrderDisplay_Tu(int _id, int userId, int deliveryId, Date shippingDate, int storeId, String address, String phone, String status, boolean isPaidBefore, int amountFromUser, int amountFromStore, int amountToStore, int amountToGD, Date createdAt, String nameStore, String deliveryName, int estimatedDeliveryDays) {
        this._id = _id;
        this.userId = userId;
