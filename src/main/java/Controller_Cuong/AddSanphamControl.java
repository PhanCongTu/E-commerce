...
public class AddSanphamControl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		daoCuong.insertProduct(pname, pdescription, pisactive, pisselling, pcategory, pstore, prating, pcreate, pprice);
		daoCuong.insertProductImage(pimage, pproductidimg);
		daoCuong.insertProductSize(psize, pquantity, pproductidsize);
